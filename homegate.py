...
#cnx = mysql.connector.connect(host='localhost', user='root', password='',database='homegatedb')
...
def getAllData(section, country, props):
    ...
    for id in ids:
            ...
            try:
                ...
                if rentalpairs['No. of rooms:']:
                    roomsProp += rentalpairs['No. of rooms:']
                if rentalpairs['Floor:']:
                    floorsProp += rentalpairs['Floor:']
                if rentalpairs['Surface living:']:
